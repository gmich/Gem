...
using Gem.Infrastructure.Cache.Events;
using System;
...
namespace Gem.Infrastructure.Cache
{
        ...
        where TCached : class
    {
        ...
        public void Add(TKey tkey, TCached tcache)
        {
            ...
            Contract.Requires((MemoryUsed + additionalSize) < buffer);
        ...
        {
            Contract.Requires(memoryToFree < MemoryUsed);
