...
namespace Gem.Infrastructure.Attributes
{
    ...
    public static class DefaultValueHelper
    {
        ...
        [Obsolete("Use AssignDefaultValues<TClass> instead")]
        private static void AssignDefaultValues_Depricated<TClass>(this TClass instance)
            where TClass : class
        {
            typeof(TClass)
            .GetProperties()
        ...
        {
            (from property in typeof(TClass).GetProperties()
             from defaultValueAttribute in property.GetCustomAttributes(true).OfType<Attribute>()
             where defaultValueAttribute is DefaultValueAttribute
             select new
             {
                 Property = property,
             ...
             .ToList()
             .ForEach(x => x.Property.SetValue(instance, x.DefaultValueAttribute.Value));
        }
    }
}
