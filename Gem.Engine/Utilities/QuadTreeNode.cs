...

{
    ...
    public class QuadTreeNode<T> where T : IHasRect
    {
        ...
        /// </summary>
        private List<T> m_contents = new List<T>();

        /// <summary>
        /// The child nodes of the QuadTree
        /// </summary>
        private List<QuadTreeNode<T>> m_nodes = new List<QuadTreeNode<T>>(4);
        ...
        private void CreateSubNodes()
        {
            ...
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(m_bounds.Location, new Point((int)halfWidth, (int)halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(new Point(m_bounds.Left, (int)(m_bounds.Top + halfHeight)), new Point((int)halfWidth, (int)halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(new Point((int)(m_bounds.Left + halfWidth), m_bounds.Top), new Point((int)halfWidth, (int)halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(new Point((int)(m_bounds.Left + halfWidth), (int)(m_bounds.Top + halfHeight)), new Point((int)halfWidth, (int)halfHeight))));
        }
