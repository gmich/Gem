...
namespace Gem.Engine.Input
{
    ...
    public class MouseInput : IInput
    {
        ...
        public void Flush()
        {
            ...
            {
                MouseMove?.Invoke(this, new MouseEventArgs(mouseState.Position));
            }
            if (IsLeftButtonClicked())
            {
                MouseDown?.Invoke(this, new MouseEventArgs(mouseState.Position));
            }
            if (IsLeftButtonReleased())
            {
                MouseUp?.Invoke(this, new MouseEventArgs(mouseState.Position));
            }
