...
namespace GameEngine2D.DrawingSystem
{
    ...
    public class AssetCreator
    {
        ...
        public Texture2D TextureFromVertices(Vertices vertices, MaterialType type, Color color, float materialScale)
        {
            ...
            materialScale /= materials[type].Width;
            ...
            return RenderTexture((int)vertsSize.X, (int)vertsSize.Y, materials[type], verticesFill, verticesOutline);
        }
        ...
        public Texture2D EllipseTexture(float radiusX, float radiusY, MaterialType type, Color color, float materialScale)
        {
            ...
            return RenderTexture((int)(radiusX * 2f), (int)(radiusY * 2f), materials[type], verticesFill, verticesOutline);
        }
